...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    if (error === 'access_denied' && report) {
      const reportNames: {[key: string]: string} = { 'enpos-ciro': 'Enpos Ciro Raporu', 'enpos-ciro-ozet': 'Enpos Ciro Özet', 'enpos-interbos': 'Enpos Interbos Ciro Raporu', 'c-bakiye': 'Cari Bakiye Raporu', 'hareket-gormeyen-cariler': 'Hareket Görmeyen Cariler' };
...
const getReportRoute = (report: ReportWithAccess) => {
  ...
  if (name.includes('enpos') && name.includes('ciro') && (name.includes('özet') || name.includes('ozet'))) return '/enpos-ciro-ozet';
